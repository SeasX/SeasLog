...
PHP_MINIT_FUNCTION(seaslog)
{
	...
	REGISTER_STRINGL_CONSTANT("TYPE_INFO_STR", TYPE_INFO_STR, 	sizeof(TYPE_INFO_STR) - 1, 	CONST_PERSISTENT | CONST_CS);
	REGISTER_STRINGL_CONSTANT("TYPE_WARN_STR", TYPE_WARN_STR, 	sizeof(TYPE_WARN_STR) - 1, 	CONST_PERSISTENT | CONST_CS);
	REGISTER_STRINGL_CONSTANT("TYPE_ERRO_STR", TYPE_ERRO_STR, 	sizeof(TYPE_ERRO_STR) - 1, 	CONST_PERSISTENT | CONST_CS);
